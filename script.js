...
var obstacle = {
    ...
    vy: 29,
    draw: function () {
        objSpeed = sec<20 ? 1:sec<40 ? 2:sec<80 ? 3:sec<120 ? 4:6
        //console.log(speed);
...
function createObstacle(m){
    ...
    if (obstacle.x - obstacle.vx < -25) {
        ...
        obstacle.x -= obstacle.vx*objSpeed;
        if(update == 'up'){
    ...
    d = Math.pow(Math.pow((box.x+37.5-obstacle.x),2) + Math.pow((box.y+37.5-obstacle.y),2),0.5);
    if( ((box.x+75==obstacle.x-25)&&(d<72.887)) || ((box.y+75==obstacle.y-25)&&(d<72.887)) 
    || Math.pow(Math.pow((box.x-obstacle.x),2) + Math.pow((box.y-obstacle.y),2),0.5)==25 
    || Math.pow(Math.pow((box.x+75-obstacle.x),2) + Math.pow((box.y-obstacle.y),2),0.5)==25
    || Math.pow(Math.pow((box.x-obstacle.x),2) + Math.pow((box.y+75-obstacle.y),2),0.5)==25
    || Math.pow(Math.pow((box.x+75-obstacle.x),2) + Math.pow((box.y+75-obstacle.y),2),0.5)==25 ){
            end();
        }
}
